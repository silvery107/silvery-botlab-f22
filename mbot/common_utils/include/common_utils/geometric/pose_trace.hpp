...
public:
    ...
    typedef std::vector<mbot_lcm_msgs::pose_xyt_t>::const_iterator const_iterator;
    ...
    */
    void addPose(const mbot_lcm_msgs::pose_xyt_t& pose);
    ...
    */
    mbot_lcm_msgs::pose_xyt_t poseAt(int64_t time) const;
    ...
    */
    void setReferencePose(const mbot_lcm_msgs::pose_xyt_t& initialInReferenceFrame);
    ...
    */
    mbot_lcm_msgs::pose_xyt_t getFrameTransform(void) const { return frameTransform_; }
    ...
    */
    ...
    const mbot_lcm_msgs::pose_xyt_t& operator[](int index) const { return trace_[index]; }
    const mbot_lcm_msgs::pose_xyt_t& at(int index)         const { return trace_.at(index); }
    const mbot_lcm_msgs::pose_xyt_t& front(void)           const { return trace_.front(); }
    const mbot_lcm_msgs::pose_xyt_t& back(void)            const { return trace_.back(); }

private:

    std::vector<mbot_lcm_msgs::pose_xyt_t> trace_;
    mbot_lcm_msgs::pose_xyt_t frameTransform_;
};
