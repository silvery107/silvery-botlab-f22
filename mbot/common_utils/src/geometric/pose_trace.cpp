...
mbot_lcm_msgs::pose_xyt_t apply_frame_transform(const mbot_lcm_msgs::pose_xyt_t& pose, const mbot_lcm_msgs::pose_xyt_t& transform);
...
void PoseTrace::addPose(const mbot_lcm_msgs::pose_xyt_t& pose)
{
...
{
    auto startRemovedIt = std::remove_if(trace_.begin(), trace_.end(), [time](const mbot_lcm_msgs::pose_xyt_t& pose) {
...
mbot_lcm_msgs::pose_xyt_t PoseTrace::poseAt(int64_t time) const
{
    if(trace_.empty())
    {
        std::cerr << "ERROR: PoseTrace::poseAt: No odometry measurements to interpolate.\n";
        return mbot_lcm_msgs::pose_xyt_t();
    }
    ...
    mbot_lcm_msgs::pose_xyt_t interpolated;
...
void PoseTrace::setReferencePose(const mbot_lcm_msgs::pose_xyt_t& initialInReferenceFrame)
{
...
mbot_lcm_msgs::pose_xyt_t apply_frame_transform(const mbot_lcm_msgs::pose_xyt_t& pose,
                                                 const mbot_lcm_msgs::pose_xyt_t& transform)
{
