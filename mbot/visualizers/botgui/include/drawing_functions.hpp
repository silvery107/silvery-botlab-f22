...
*/
void draw_robot(const mbot_lcm_msgs::pose_xyt_t& pose, const float color[4],const float body_color[4], vx_buffer_t* buffer);
...
*/
void draw_path(const mbot_lcm_msgs::robot_path_t& path, const float color[4], vx_buffer_t* buffer);
