...
public:
    ...
    */
    ...
    void handleOdometry(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const mbot_lcm_msgs::odometry_t* odom);
    void handleLaser(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const mbot_lcm_msgs::lidar_t* laser);
    void handlePath(const lcm::ReceiveBuffer* rbuf, const std::string& channel, const mbot_lcm_msgs::robot_path_t* path);
...
private:
    ...
    mbot_lcm_msgs::robot_path_t path_;             // Current path being followed by the robot
    mbot_lcm_msgs::odometry_t odometry_;           // Most recent odometry measurement
    mbot_lcm_msgs::pose_xyt_t slamPose_;           // Pose estimated by the SLAM process
    ...
    // Additional helpers
    void addPose(const mbot_lcm_msgs::pose_xyt_t& pose, const std::string& channel);
